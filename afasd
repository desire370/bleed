...
if getgenv().script_key == valid_key then
    print("yes")
task.wait(19) -- erm it give time to inject so
    loadstring(game:HttpGet("https://raw.githubusercontent.com/desire370/bleed/refs/heads/main/bleed%20(dahood%20verison%20plus%20copys).lua"))()
print("discord.gg/bleednet legit cheating")
else
    warn("Invalid key.")
end
