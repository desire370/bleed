--[[ 
    ...
    @description
       hi im the creator of the bleed.net yes it is a copy of draax ui but it is a very go and high uqiue code and more have to offer in the code 
]]
...
if not isfolder("Bleed") then
    makefolder("Bleed") 
end

if not isfolder("Bleed/configs") then
    makefolder("Bleed/configs")
end

if not isfolder("Bleed/configs/da_hood") then
    makefolder("Bleed/configs/da_hood")
end
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'Bleed<font color="rgb(255, 0, 0)">.net</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("Bleed.net")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("Bleed/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("Bleed/configs/da_hood") do
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'Bleed<font color="rgb(168, 157, 159)">.net</font>',}
                
                do -- src/Lua/Scripts/universal/components/
                    do -- src/Lua/Scripts/universal/components/a_aimassist.lua
                    -- hey im simga tong tong 
